...
export const HeroParallaxTab = ({
  ...
  return (
    <div
      ref={ref}
      className="overflow-hidden h-[2250px] antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className={`w-full h-[15em] rounded-lg ${bgColor}`}>
          <Image
